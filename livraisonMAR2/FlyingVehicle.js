...
this.oldposition = configuration.position ; 
...
this.firsttime= false;
		...
		var d= this.oldposition.distanceTo(this.position);
		var v1 = new THREE.Vector3 (this.oldposition.x, this.oldposition.y, 0);
var v2 = new THREE.Vector3 (this.position, this.position, 0);
